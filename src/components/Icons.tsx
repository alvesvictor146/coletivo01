...
export const Bus: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-bus ${className}`}
    {...props}
  >
    <path d="M8 6v6" />
    <path d="M15 6v6" />
...
export const MessageCircle: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Minus: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
